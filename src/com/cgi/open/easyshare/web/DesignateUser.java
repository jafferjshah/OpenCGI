...
/**
 * Servlet implementation class DesignateUser
 */
public class DesignateUser extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DesignateUser() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		sr.initServiceResponse(myRequest, "DesignateUser");
		...
		try {
			isAssigned= easyshare.designateUser(email, userType);
			sr.setCode("SUCCESS");
