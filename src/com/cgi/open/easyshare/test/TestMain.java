...
public class TestMain {
	...
	public static void main(String[] args)
			...
			UserTypeNotValidException, SessionNotFoundException, DuplicateSessionException, PresentAsOtherUserTypeException, AdminAssignedException, ResourceNotFoundException, AttendeeNotFoundException, FacilitatorNotFoundException, AppointmentNotFoundException, DuplicateAppointmentException, DuplicateResourceException {
		jafferTest();
	}
	...
	public static void sanjanaTest() throws DuplicateSessionException,
			...
			PresentAsSameUserTypeException, UserNotFoundException,
			 AdminAssignedException,
			ResourceNotFoundException, DuplicateAppointmentException, DuplicateResourceException {
	...
	public static void jafferTest() throws PresentAsSameUserTypeException,
			...
			AttendeeNotFoundException, FacilitatorNotFoundException, AppointmentNotFoundException, DuplicateAppointmentException, DuplicateResourceException {
		...
		{
			sessionId=easy.createSession("Core java");
		...
		{
			sessionId2=easy.createSession("Advanced Hibernate");
		...
		if(sp.isServReqValid(sd6, "anupama.charles", sessionId))
		{
			...
			easy.addAppointment(sessionId, "18/01/2011","1500","1800");
			//easy.addAppointment(sessionId, "17/01/2011","1500","1800");
		}
		...
		{
			easy.addMessage(sessionId, "subject1", "text1");
		}
